//
//  VerificationNumberInputViewTextField.swift
//  FeatureSignIn
//
...
class VerificationNumberInputViewTextField: UITextField {
    ...
    override func rightViewRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x: bounds.width - 73 , y: 16, width: 57, height: 24)
    }
